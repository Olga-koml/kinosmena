    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_coefficient_shift', models.BooleanField(default=False, verbose_name='Коэффициент day-off х вся смена')),
                ('services_sum', models.PositiveSmallIntegerField(default=0, verbose_name='Дополнительные услуги')),
